...
and ask if $\hat{r_{C}^{\star}}>\hat{r_{I}^{\star}}+\sigma$. If this
still holds true, then you can be approximately 68\% percent sure
that the Cambodian place $C$ is indeed superior. If $\hat{r_{C}^{\star}}>\hat{r_{I}^{\star}}+2\sigma$,
